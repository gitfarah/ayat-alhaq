// Generates the compact runtime layout used by the KFGQPC V1 Mushaf view.
//
// Source: QUL's KFGQPC V1 layout (1405H print):
...
//   dart run tool/generate_qul_v1_layout.dart

import 'dart:async';
import 'dart:convert';
import 'dart:io';

const _baseUrl = 'https://qul.tarteel.ai/resources/mushaf-layout/15?page=';
const _output = 'assets/quran/mushaf_v1_1405h_layout.json';
...
Future<void> main() async {
  ...
  await file.writeAsString(jsonEncode({
    'source': 'https://qul.tarteel.ai/resources/mushaf-layout/15',
