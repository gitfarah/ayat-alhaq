// Generates the compact runtime layout used by the KFGQPC V2 Mushaf view.
//
// Source: QUL's public Mushaf Al Madinah V2 (1421H) page preview:
// https://qul.tarteel.ai/mushaf_layouts/1
// QUL source code is MIT licensed: https://github.com/TarteelAI/quranic-universal-library
//
// Run from the project root:
//   dart run tool/generate_qul_v2_layout.dart

import 'dart:async';
import 'dart:convert';
import 'dart:io';

const _baseUrl = 'https://qul.tarteel.ai/mushaf_layouts/1?page_number=';
const _output = 'assets/quran/mushaf_v2_1421h_layout.json';
...
Future<void> main() async {
  ...
  try {
    await Future.wait(List.generate(30, (_) => worker()));
  } finally {
  ...
  await file.writeAsString(jsonEncode({
    'source': 'https://qul.tarteel.ai/mushaf_layouts/1',
    'name': 'Mushaf Al Madinah V2 (1421H print)',
    'pages': pages,
  }));
